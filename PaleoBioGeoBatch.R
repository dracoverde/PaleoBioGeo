...
# file with localities of of species, including GPS coordinates of locality or a centroid of the basin. localities have unique identifiers matched with those used in 'species.localities.stratigiraphy' file. These do not repeat in this file.
